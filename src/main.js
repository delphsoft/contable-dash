...
const VIEWS = {
  'ct-overview':    { render: renderOverview,       title: 'Overview',          sub: 'Resumen ejecutivo del período' },
  'ct-estado':      { render: renderEstadoContable, title: 'Estado Contable',   sub: 'Resultados, márgenes y gastos' },
  ...
  'ct-superadmin':  { render: renderSuperAdmin,     title: 'Super Admin',       sub: 'Panel estratégico — acceso restringido', nomemo: true },
...
const mutableViews = new Set(['ff-dashboard','ff-facturas','ff-mercadopago','ct-superadmin'])
